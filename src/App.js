  ...
  <>
    ...
    <VideoComparison
      ...
      comparisons={[
        {
        photos: [  // 1st pair
        require("./assets/images/before2-1.jpg"),
        require("./assets/images/before2-2.jpg"),
        require("./assets/images/before2-3.jpg"),
        require("./assets/images/before2-4.jpg"),
        require("./assets/images/before2-5.jpg"),
        require("./assets/images/before2-6.jpg"),
        require("./assets/images/before2-7.jpg"),
        ],
        video: require("./assets/videos/after2.mp4")
        },
